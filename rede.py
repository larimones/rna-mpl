...
print(y_test)
print('esse é o X_teste, e acima o y teste', X_test)
...
weights_hidden_output = np.random.normal(0, scale=0.01, size=(N_hidden, N_output))
...
# Forward Pass
        ...
        #print('AQui As saídas da rede são ',output)
#-------------------------------------------    
